...
if __name__ == "__main__":
    ...
    if train_il:
        ...
        reward,  epoch_reward, _, _ = evaluate_policy(
        ...
        model_dir = "weight/" + il_name + "_" + env_name + "_" + str(train_il_ep)
        bc_trainer = bc.reconstruct_policy(model_dir)
        # evaluate the trained agent
        reward, epoch_reward, _, _ = evaluate_policy(bc_trainer, env, n_eval_episodes=n_eval_episodes, render=False,reward_threshold=18,env_name=env_name)
