"""Description: This script is adapted from imitation/src/imitation/algorithms/bc.py
Link: https://github.com/HumanCompatibleAI/imitation/blob/master/src/imitation/algorithms/bc.py
...
import torch as th
import tqdm
from stable_baselines3.common import utils, vec_env, policies
...
class BehaviorCloningLossCalculator:
    ...
    def __call__(
        ...
        # neglogp: log likelihood of taking those actions
        # ent_loss: entropy of the action distribution
        # l2_loss: the squared difference between a prediction and the actual value,
